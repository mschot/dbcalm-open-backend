...
class Mysql(adapter.Adapter):
    """MySQL/Percona XtraBackup adapter.

    Uses the same backup/restore logic as MariaDB since XtraBackup
    uses identical command syntax.
    """
